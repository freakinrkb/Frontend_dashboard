  ...
  return (
    <section className="py-10 bg-[#F9FBFD]">
      <div className="container ">
        <div class="flex flex-wrap justify-evenly gap-2  px-8 py-10">
          <div class="shadow-[0px_3px_5px_rgba(0,_0,_0,_0.1)] box min-w-60 max-w-80 flex-1 bg-white p-10 text-center flex flex-col items-center justify-center">
            <img className="pb-4" alt="" src={icon} />

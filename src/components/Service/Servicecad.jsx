...
const Servicecad = ({ src, title, description, linkto, additionalClass }) => {
  return (
    <div
      className={`flex min-h-[20rem] flex-grow flex-col space-y-4 border-[1px] border-[#EDEEF0] bg-[hsl(210,50%,96%)] p-10 py-14 hover:bg-white hover:ease-in ${additionalClass} mb-6`}
    >

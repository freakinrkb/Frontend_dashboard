...
const Servicecad = ({ src, title, description, linkto, additionalClass }) => {
    return (
      <div
      className={`bg-[#EDEEF0] flex min-h-[20rem] min-w-[20rem] flex-grow flex-col space-y-4 border-[1px] border-[#EDEEF0] p-10 py-14 hover:bg-white hover:ease-in ${additionalClass} mb-6`}
      >
